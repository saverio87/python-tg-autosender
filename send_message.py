...
templates = {'ad_vid_1': send_template_a,
             'ad_vid_2': send_template_b, 'ad_img_3': send_template_c}
...
async def main():
    ...
    for chat in chats:
        ...
        templateKey = templatesList[random.randrange(0, len(templatesList))]
        start_time = time.time()
        print('- Sending', templateKey, 'to group id ', chat.id)
